...
def build_app_summary() -> dict[str, object]:
    ...
    return {
        "project_name": 'JWT Login System MVP',
        "requested_prompt": 'Build a login system with JWT auth',
        "summary": 'Generate a backend-oriented starter project for the requested capability.',
        "status": "scaffolded",
        "features": ['JWT-ready auth planning', 'modular Python scaffold', 'closed-loop execution', 'automatic repair hooks'],
